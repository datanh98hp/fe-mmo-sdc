<template>
 <Layout>
     ...
     <div class="row">
         <CardSalary name="Doanh thu tháng" :value="this.handleCurrency(this.$store.getters.getTunorver.curent_Month_Turnover)" theme="border-left-primary" />
         <CardSalary name="Doanh hôm nay" :value="this.handleCurrency(this.$store.getters.getTunorver.today_Turnover)" theme="border-left-success" />
         <CardSalary name="Đang chờ duyệt" :value="this.handleCurrency(this.$store.getters.getTunorver.watting_Turnover)" theme="border-left-warning" />
         <CardSalary name="Tổng" :value="this.handleCurrency(this.$store.getters.getTunorver.total_Turnover)" theme="border-left-info" />
     </div>
     ...
     <div class="row justify-content-md-around">
         ...
         <div class="col-sm-6">
             <ChartBar :data="this.chartDataSys" />
         </div>
     </div>
     <div class="row">
